...
export type TaxArticleSection = {
  title: string;
  content: ReactNode;
};

export type TaxArticleContent = {
  title: string;
  description: string;
  path: string;
  eyebrow?: string;
  intro: ReactNode;
  sections: TaxArticleSection[];
  faqItems: FAQItem[];
};

export function TaxArticlePage({ content }: { content: TaxArticleContent }) {
      ...
      <Container>
        <div className="max-w-4xl">
          ...
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-emerald-300">
            {content.eyebrow ?? "Taxes and Money"}
          </p>
