    ...
    <footer className="border-t border-white/10 bg-slate-950">
      <Container className="grid gap-8 py-8 text-sm text-slate-400 md:grid-cols-[1.2fr_1fr]">
        <div className="max-w-xl">
          <p className="font-medium text-slate-200">Finance Calculators Hub</p>
          <p className="mt-2">
            Public utility calculators built for common US financial decisions.
            Calculator outputs are educational estimates only and are not
